 ...
 * @LastEditTime: 2021-05-24 20:49:11
...
if ($('.poster-imgbox').length) {
    tbquire(["qrcode"], function () {
        ...
        poster.init({
            ...
            qrcode: qrcanvas,
            onerror: function (e) {
                $(e).find('.poster-loading').html('<div class="c-red box-body" style="font-size:60px;"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i></div><div class="c-red box-body">海报加载失败</div>');
            },
        ...
        function posterDownload(e) {
            ...
            const $btn = e.querySelector('.poster-download')
